...
const lang = {
  ...
  finished_analyzing: 'Analyzation of %1% finished.',
  initialization: 'Initializing tasks to have %1% Threads x %2% Repetitions todos',
  ...
  starting_analyzation: 'Starting analysation of %1%.',
  ...
  openapi_invalid: 'Your Open-Api document is not valid, please check for errors!',
  no_openapi_document_given: 'You need to provide an Open-Api document path.',
  no_xml_content_type: 'The content-type application/jason is not */xml.',
  ...
  no_har_document_given: 'The  path didn\'t point to an HAR document.',
